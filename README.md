...
1. **Open the project page on GitHub.** Launch your web browser (Chrome, Edge, Safari, etc.). If you are already reading this README on GitHub, you can stay on this page. Otherwise, type the repository address (the link where you first saw these files) into the address bar and press **Enter**. You should see a list of files and folders.
